...
export default function Detail({ dexNumber }) {
    ...
    <div className="card">
      <div className="card__top">
        <div className="card__left">
          ...
          <h3 className="name">{selectedPal.name}</h3>
        </div>

        <div className="card__right">
          <Image
            src={selectedPal.imageWiki}
            width={100}
            height={100}
      ...
      <div className="card__bottom">
        <div className="skill">
          <h4>파트너 스킬</h4>
          <div className="aura">
            <h3>{selectedPal.aura.name}</h3>
            <p>{selectedPal.aura.description}</p>
          </div>
        </div>
              ...
              <li key={index}>
                <div className="suitability-item">
                  {getSuitabilityImage(item.type) && (
                    <Image
                      className="type"
                      src={getSuitabilityImage(item.type)}
                      alt={item.type}
                      width={50}
                      height={50}
                    />
