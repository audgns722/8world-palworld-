...
export const metadata = {
  ...
  images: 'https://github.com/yunyoungsik/palworld/blob/main/public/image/thmbnail/8world.co.kr.jpg?raw=true',
  openGraph: {
    title: '8World',
    description: '팰월드 정보를 검색을 통해서 쉽게 확인하세요.',
